...
# Images to predict
imgs_test = [
    os.path.join(current_dir, "../data/test/test-0.png"),
    os.path.join(current_dir, "../data/test/test-1.png"),
    os.path.join(current_dir, "../data/test/test-2.jpg"),
    os.path.join(current_dir, "../data/test/test-3.jpg"),
    os.path.join(current_dir, "../data/test/test-4.jpg"),
]
